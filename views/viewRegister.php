		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-12">
				<div class="comment-form">
					<form method="post" action="user&create" class="contact1-form validate-form">
						<div class="row">
							<div class="col-sm-6">
								<input type="text" aria-required="true" minlength="3" name="firstName" class="form-control" placeholder="Entrez votre prénom" aria-invalid="true" required>
							</div>
							<div class="col-sm-6">
								<input type="text" aria-required="true" minlength="3" name="lastName" class="form-control" placeholder="Entrez votre nom" aria-invalid="true" required>
							</div>
							<div class="col-sm-12">
