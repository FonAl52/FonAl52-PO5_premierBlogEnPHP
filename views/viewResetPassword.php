<section class="comment-section">
    <div class="container">
                        ...
                        <form method="post" action="user&changePassword" class="contact1-form validate-form" id="password-form">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <b class="text-danger"><?php if (isset($errors['new_password'])) echo htmlspecialchars($errors['new_password']) ?></b>
                                </div>
                                <div class="col-sm-12">
                                    ...
                                    <b class="text-danger"><?php if (isset($errors['confirm_password'])) echo htmlspecialchars($errors['confirm_password']) ?></b>
                                </div>
                        ...
                        <form method="post" action="user&verifyEmail" class="contact1-form validate-form" id="email-form">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <b class="text-danger"><?php if (isset($_SESSION['email'])) echo htmlspecialchars($_SESSION['email']) ?></b>
                                </div>
                                <div class="col-sm-12 center-text">
        ...
        <?php } ?>
        <b class="text-danger"><?php if (isset($errors['nom_de_l_erreur'])) echo htmlspecialchars($errors['nom_de_l_erreur']) ?></b>
    </div>
</section>