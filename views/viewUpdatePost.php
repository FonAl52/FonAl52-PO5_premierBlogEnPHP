    ...
    <div class="row">
      ...
      <div class="col-lg-8 col-md-12">
        <div class="comment-form"><?php if (isset($errors) && !empty($errors)) : ?>
          ...
          <?php endif; ?>
          <form method="post" action="post&update&id=<?= $post[0]->getId() ?>" class="contact1-form validate-form" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-sm-12 center-text">
                <button class="submit-btn" type="submit" id="form-submit"><b>Modifier l'article</b></button>
              </div>
            </div>
          </form>
        </div>
